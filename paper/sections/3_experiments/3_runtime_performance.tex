...
Table~\ref{tab:table_bataneih} summarizes the progressive runtime improvements obtained for the method of Bataineh et al.~\cite{Bataineh2011}.
...
\begin{table}[t]
    ...
    \end{tabular}
    \caption{Runtime comparison of optimization stages for Bataneih's method on the medium-resolution image.}
    \label{tab:table_bataneih}
\end{table}
