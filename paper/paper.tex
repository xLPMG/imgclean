...
\affiliation{%
  ...
  \country{Germany}}
\email{luca-philipp.grumbach@uni-jena.de}
...
\begin{abstract}
  ...
  This paper investigates adaptive thresholding techniques for producing clean black-and-white representations of noisy color images, with a focus on efficient processing of PPM3 image data.
  ...
  All methods are evaluated with respect to binarization quality, particularly in terms of how efficiently they enhance the readability of textual content in noisy images, their robustness to different window sizes, and their computational performance.
...
\keywords{adaptive thresholding, image binarization, scanned document enhancement, integral images, sliding-window optimization, PPM images, parallel image processing}
...
% INTRODUCTION ------------------------------%
%--------------------------------------------%
\input{sections/1_introduction/0_intro}
\input{sections/1_introduction/1_background}
\input{sections/1_introduction/2_related_work}
\input{sections/1_introduction/3_contributions}
\input{sections/1_introduction/4_outline}

%--------------------------------------------%
% ADAPTIVE THRESHOLDING APPROACHES ----------%
%--------------------------------------------%
\input{sections/2_algorithms/0_algo_intro}
\input{sections/2_algorithms/1_traditional_approaches}
...
\input{sections/2_algorithms/2_modern_approaches}
\input{sections/2_algorithms/3_performance_optimizations}

%--------------------------------------------%
% EXPERIMENTS AND RESULTS -------------------%
%--------------------------------------------%
\input{sections/3_experiments/0_experiments}
\input{sections/3_experiments/1_experimental_setup}
...
\input{sections/3_experiments/2_qualitative_comparison}
\input{sections/3_experiments/3_runtime_performance}

%--------------------------------------------%
% CONCLUSION --------------------------------%
%--------------------------------------------%
\input{sections/4_conclusions/1_conclusion}
